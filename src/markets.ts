...
export const markets: Record<string, Market> = {
    ...
    'CAD/CHF (OTC)': { name: 'CAD/CHF (OTC)', price: 0.6540, active: true, payout: 80, trend: 'random', volatility: 0.0001, targetPrice: null, isFrozen: false, lastChange: 0, maxTradeAmount: 50000 },
    'EUR/CHF (OTC)': { name: 'EUR/CHF (OTC)', price: 0.9540, active: true, payout: 80, trend: 'random', volatility: 0.0001, targetPrice: null, isFrozen: false, lastChange: 0, maxTradeAmount: 50000 },
    'GBP/AUD (OTC)': { name: 'GBP/AUD (OTC)', price: 1.9540, active: true, payout: 80, trend: 'random', volatility: 0.0001, targetPrice: null, isFrozen: false, lastChange: 0, maxTradeAmount: 50000 },
    'USD/ZAR (OTC)': { name: 'USD/ZAR (OTC)', price: 18.40, active: true, payout: 80, trend: 'random', volatility: 0.005, targetPrice: null, isFrozen: false, lastChange: 0, maxTradeAmount: 50000 },
